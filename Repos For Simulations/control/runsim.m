...
% Prompt the user to input the trajectory function dynamically
prompt = 'Enter the name of the trajectory function (without @): ';
traj_function_name = input(prompt, 's');
trajhandle = str2func(traj_function_name);
