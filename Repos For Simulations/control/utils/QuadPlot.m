classdef QuadPlot < handle
    ...
    methods
        ...
        function Q = QuadPlot(qn, state, wingspan, height, color, max_iter, h_3d)
            ...
            Q.h_3d = h_3d;
            hold(Q.h_3d, 'on')
            % Plot the current position and desired position in 3D
...
legend([Q.h_pos_hist, Q.h_pos_des_hist], {'Current Position', 'Desired Position'}, 'Location', 'best');

% Label the axes and add a title
xlabel('X');
ylabel('Y');
zlabel('Z');
title('Current and Desired Positions');
